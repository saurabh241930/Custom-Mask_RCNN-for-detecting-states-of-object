...
class ObjectsDataset(utils.Dataset):
    ...
    def load_objects(self, dataset_dir, subset, hc=False):
        """Load a subset of the Balloon dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("objects", 1, "openbook")
        self.add_class("objects", 2, "closebook")
        self.add_class("objects", 3, "unoccupied chair")
        self.add_class("objects", 4, "desk")
        self.add_class("objects", 5, "person")
        #if hc is True:
        #    for i in range(1,14):
        #        self.add_class("notebook", i, "{}".format(i))
        #    self.add_class("notebook", 14, "openbook")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a openbook dataset image, delegate to parent class.
        ...
        for i, p in enumerate(class_names):
            ...
            if p['name'] == 'openbook':
                class_ids[i] = 1
            elif p['name'] == 'closebook':
                class_ids[i] = 2
            elif p['name'] == 'unoccupied chair':
                class_ids[i] = 3
            elif p['name'] == 'desk':
                class_ids[i] = 4
            elif p['name'] == 'person':
...
def detect_and_color_splash(model, image_path=None, video_path=None):
    ...
    class_names = ['BG', 'openbook', 'closebook', 'unoccupied chair', 'desk','person']
    # Image or video?
    if image_path:
